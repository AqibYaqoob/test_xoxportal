...
@section('page_header')
    ...
    <h1 class="page-title">
        ...
        <div class="panel-title" style=";margin-left: 82%;padding-left: 100px;margin-top: 50px;padding-bottom: 0%;" ;="">
            <form role="form" action="{{ action('VoyagerPageBlocks\PageController@preview')}}" method="POST" target="_blank"  enctype="multipart/form-data">
                {{ csrf_field() }}
                <input type="hidden" name="_token" value="{{ csrf_token() }}"> <!-- preview button -->
                <input type="hidden" name="page_id" value="{{$page->id}}">
                <button type="submit" class="btn btn-warning btn-sm">Preview
                    <img style="height: 25px;align-content: center" src="{{url('images/preview.png')}}"></button>
            </form>
        </div>
    </div>
...
@section('content')
        <div class="row">
            <div class="col-md-3 col-lg-2">
                ...
                <div class="panel panel-bordered panel-primary" style="padding-top: 0%;padding-bottom: 3%;padding-left: 11%;"> <!-- panel -->
                    <form role="form" action="{{ action('VoyagerPageBlocks\PageController@publish')}}" method="POST">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}"> <!-- publish button -->
